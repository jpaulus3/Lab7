...
public class RPSLSpock {
    ...
    /**
     * @author-Jett Paulus
     * @param-String pick, the option that the user types
     * @return-boolean, returns true if the pick is a valid value in RPSLSpock
     */
    ...
    /**
     * @author-Jett Paulus
     * @return-String, generates and returns a random pick from RPSLSpock
     */
    ...
    /**
     * @author-Jett Paulus
     * @param c_pick, the value that the computer picks
     * @param h_pick, the value that the human picks
     * @return-boolean, returns true if the computer wins, otherwise returns false
     */
